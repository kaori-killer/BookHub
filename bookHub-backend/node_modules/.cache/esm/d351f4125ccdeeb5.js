let bookRepository;_5cc‍.x([["getBooks",()=>getBooks],["getById",()=>getById],["createBook",()=>createBook],["updateBook",()=>updateBook],["deleteBook",()=>deleteBook]]);_5cc‍.w("../data/books.js",[["*",null,function(v){bookRepository=v}]]);
...
const client_secret = "I73xFgMJIc";
  ...
  request.get(options, (error, response, body) => {
    if (!error && response.statusCode == 200) {
      ...
      _5cc‍.g.console.log('error = ' + JSON.stringify(response));
    }
  })
